...
日期：2026-05-26
仓库路径变量：`$SFA_REPO_MOBILE_SFA_ANDROID`
...
| 路径变量 | `$SFA_REPO_MOBILE_SFA_ANDROID` |
...
- 本次 Android 改动文件运行：
  - `scripts/mobile-mechanical-quality.sh $SFA_REPO_MOBILE_SFA_ANDROID <changed-files...>`
  - `scripts/architecture-drift-gate.sh $SFA_REPO_MOBILE_SFA_ANDROID <changed-files...>`
