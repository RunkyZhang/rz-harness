...
| Test Agent verification | `verification_status: GOAL_ACHIEVED` | `changes/<change-id>/test-agent-verification.md` | 测试 Agent 独立验收通过 |
...
| 独立验收 | Test Agent | 按已确认测试方案验收、反馈问题、复测修复 | 是 |
