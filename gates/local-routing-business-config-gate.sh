...
usage() {
  cat <<'USAGE'
Usage:
  gates/local-routing-business-config-gate.sh [--allow-business-config] <changed-file> [changed-file...]
...
[[ "$#" -gt 0 ]] || fail \
  ...
  "gates/local-routing-business-config-gate.sh /absolute/path/src/page.vue"
